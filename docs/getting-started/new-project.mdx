...
6. Review the [Project File](/api/project-format#project-file) (`*.project.json`) and [Start using Argon!](./common-usage.mdx)
...
4. Review the [Project File](/api/project-format#project-file) (`*.project.json`) and [Start using Argon!](./advanced-usage.mdx)
...
- **Quick** - Just like the **Place** but with most services already included in the [Project File](/api/project-format#project-file), recommended for beginners
...
All of this settings can be saved in the [Global Configuration](../customization.mdx#global-configuration) file to use them as default for the next project.

...
Argon allows you to automate your workflows with its powerful CLI. You can add it to your [CI/CD](https://en.wikipedia.org/wiki/CI/CD) pipeline to make sure your project is always up-to-date and working as expected or to even deploy it! Here is an example [GitHub Action](https://github.com/features/actions) that builds a plugin and then releases it on GitHub:
